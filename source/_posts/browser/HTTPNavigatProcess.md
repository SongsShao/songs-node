...
当前浏览器没有监听 `beforeunload` 事件或者同意了继续后续流程，那么浏览器便进入下图的状态：

![开始加载URL浏览器状态](https://pic.imgdb.cn/item/661ccfd568eb9357138671dd.png)
...
![非同一站点使用不同的渲染进程](https://pic.imgdb.cn/item/661cf5bf68eb935713bb95e2.png)
