...
document.addEventListener('page:loaded', function () {
  if (CONFIG.disqus.count) {
    if (window.DISQUSWIDGETS) {
      ...
      NexT.utils.getScript("https://".concat(CONFIG.disqus.shortname, ".disqus.com/count.js"), {
        attributes: {
          id: 'dsq-count-scr',
          defer: true
        }
  ...
  if (CONFIG.page.comments) {
    ...
    NexT.utils.loadComments('#disqus_thread').then(function () {
      if (window.DISQUS) {
        ...
        NexT.utils.getScript("https://".concat(CONFIG.disqus.shortname, ".disqus.com/embed.js"), {
          attributes: {
            dataset: {
              timestamp: '' + +new Date()
            }
